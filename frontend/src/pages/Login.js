...
import { TrendingUp, Shield, Lock, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'radial-gradient(900px circle at 20% 10%, rgba(58,134,255,0.12), transparent 60%), radial-gradient(700px circle at 85% 25%, rgba(255,190,11,0.07), transparent 55%)'
      }} />
        ...
        <div style={{ maxWidth: 480 }}>
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
              <div style={{ width: 32, height: 32, background: 'hsl(214,100%,60%,0.12)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
      ...
      <div style={{
        ...
        <style>{`.right-panel { @media (min-width: 900px) { flex-shrink: 0; } }`}</style>
        <div style={{
          width: '100%',
          ...
          <p style={{ fontSize: 13, color: 'hsl(215,16%,70%)', marginBottom: 28 }}>Bem-vindo de volta. Insira as suas credenciais.</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? 'hsl(214,100%,60%,0.5)' : 'hsl(214,100%,60%)',
          ...
          <div style={{ textAlign: 'center', marginTop: 20 }}>
            ...
            <Link data-testid="login-register-link" to="/register" style={{ fontSize: 13, color: 'hsl(214,100%,60%)', fontWeight: 600, textDecoration: 'none' }}>Registar</Link>
          </div>
